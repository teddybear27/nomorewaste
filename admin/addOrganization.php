  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ajout association</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Ajout association</h6>
        </nav>
    ...
    <div class="form-v1-content">
      <div class="wizard-form">
            <form class="form-register" action="addOrganizationBack.php" method="post">
              <div id="form-total">
                <!-- SECTION 1 -->
                  <h2>
                ...
                <div class="form-row">
                  <div class="form-holder form-holder-2">
                    <fieldset>
                      <legend>Nom de l'association</legend>
                      <input type="text" class="form-control" id="firstname" name="organizationName" placeholder="Nom de l'association" required>
                    </fieldset>
                  </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row form-row-date">
                  <div class="form-holder form-holder-2">
                    <fieldset>
                      <legend>Année création</legend>
                      <input type="text" class="form-control" name="creationYear" id="creationYear" placeholder="Année création" required>
                    </fieldset>
                  </div>
                </div>
                <div class="form-row">
