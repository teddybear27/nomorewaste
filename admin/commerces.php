    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Commerces</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Liste Commerces</h6>
                <a href="addShop.php" class="text-secondary font-weight-bold text-xs">
                    Ajouter un commerce
                </a>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Commerce</th>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">                          
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0"><?=$data["mail"]?></p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?=$data["autorisation"]?></p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?=$data["categorie"]?></p>
                      </td>
                      ...
                      <td class="align-middle">
                        ...
                        <div class="col-md-4 text-end">
                          <a href="deleteShop.php">
                              <?php $_SESSION['deleteS'] = $data["mail"]; ?> 
