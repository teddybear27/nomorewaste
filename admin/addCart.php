...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="paniers.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Paniers</li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ajout Panier</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Ajout Panier</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <form class="form-register" action="addCartBack.php" method="post">
        <div class="col-12 col-xl-4">
          <div class="card card-plain h-100">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-md-8 d-flex align-items-center">
                  <h6 class="mb-0">Ajout Panier</h6>
                </div>
              </div>                  
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Etat:</strong> &nbsp;
                  <select name="etat">
                    <option value="collecte" selected="selected">Collecte </option>
