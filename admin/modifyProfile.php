            ...
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">                  
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Date de Naissance:</strong> &nbsp; <?=$data["date_naissance"]?></li>
      ...
      <div class="card-body p-3">
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Prenom:</strong> &nbsp;
            <input type="text"  name="firstname" placeholder="Nom de Famille" value="<?=$data["prenom"]?>" required>        
          </li>
          <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Date de Naissance:</strong> &nbsp;
            <input type="date" name="birthday" placeholder="Prénom" value="<?=$data["date_naissance"]?>" required>        
          </li>
          ...
          <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mot de Passe:</strong> &nbsp; 
            <input type="password" name="pwd" placeholder="Mot de passe" value="<?=$data["mdp"]?>" required>
          </li>
          <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Verification Mot de Passe:</strong> &nbsp; 
            <input type="password" name="pwdConfirm" placeholder="Verification mot de passe" required>
          </li>
          ...
          <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Pays:</strong> &nbsp; 
            <select name="country">
<option value="<?=$data["pays"]?>" selected="selected">France </option>
