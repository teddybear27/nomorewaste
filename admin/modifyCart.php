...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Modification Panier</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Modification Panier</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <form class="form-register" action="modifyCartBack.php" method="post">
        <div class="col-12 col-xl-4">
          <div class="card card-plain h-100">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-md-8 d-flex align-items-center">
                  <h6 class="mb-0">Modification Panier</h6>
                </div>
              </div>                  
