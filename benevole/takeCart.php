...
$actor = $data["acteur"];
$resActor = getActorInfosFromCart($connect,$idActor,$actor);
$dataActor = $resActor->fetch();
?>
...
<head>
  ...
  <title>
    Dashboard Benevole - Commander Paniers
  </title>
  <!--     Fonts and icons     -->
            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="takeCartBack.php" title="Ajouter au planning">
                      <i class='fa fa-plus' style="color:#76a89c"></i>
                  </a>
                </div>
              </div>                  
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Téléphone:</strong> &nbsp;
                  <?=$dataActor["numero_telephone"]?>        
                </li>
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Adresse:</strong> &nbsp;
                  <?=$dataActor["adresse"]." ".$dataActor["code_postal"]." ".$dataActor["ville"].", ".$dataActor["pays"]?>        
                </li>
              </ul>
            </div>
          </div>
